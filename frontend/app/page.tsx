          ...
          <div className="rounded-xl border border-white/10 bg-zinc-900 overflow-hidden text-xs min-w-[320px]">
            ...
            {[
              ...
              >
                ...
                <span className={row.status === 'expiring' ? 'text-orange-400' : row.status === 'expired' ? 'text-red-400' : 'text-zinc-400'}>
                  {row.expiry}
                </span>
                <span className="text-zinc-300">{row.mrp}</span>
                <span className={
                  row.stock === 0 ? 'text-red-400' : row.stock < 10 ? 'text-orange-400' : 'text-emerald-400'
                }>
